...
public class CutScene1_6 : MonoBehaviour
{
    [Header("UI")]
    ...
    public void _ContinueMainDialogue()
    {
        ...
        {
            StartDialogueSet(
                new string[] { "Until I noticed, in the corner of my eye was my journal ON THE BEDSIDE TABLE. The same journal I used to write down my findings and notes during my pursuit in caring for the Raymundo house." },
                new string[] { "" }
            );
            _DialogueEnd = true;
        }
